...
{
    public class HorusExecutor : Executor
    {
        ...
        public HorusExecutor(GameAI ai, Duel duel) : base(ai, duel)
        {
            ...
            AddExecutor(ExecutorType.Activate, (int)CardId.StampingDestruction, StampingDestruction);
            ...
            AddExecutor(ExecutorType.Activate, (int)CardId.HammerShot, HammerShot);
